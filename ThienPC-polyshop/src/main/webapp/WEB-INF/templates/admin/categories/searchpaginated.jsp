			...
			<div class="col mt-4">
				<div class="card">
					<div class="card-header">
						<h2>Danh sÃ¡ch cÃ¡c loáº¡i sáº£n pháº©m</h2>
					</div>
					<div class="card-body">
						...
						<div class="row mt-2 mb-2">
							<div class="col">
								...
								<div class="float-right">
									<a class="btn btn-outline-primary" th:href="@{/admin/categories/add}">ThÃªm má»i
										sáº£n pháº©m</a>
								</div>
							</div>
						</div>
						...
						<div class="row" th:if="${!categoryPage.hasContent()}">
							<div class="col">
								<div class="alert alert-danger" role="alert">
									<strong>KhÃ´ng tÃ¬m tháº¥y sáº£n pháº©m</strong>
								</div>
							</div>
						</div>
								...
								<tr th:each="category,isStat :${categoryPage.content}">
									...
									<td class="float-right">
										<a th:href="@{'/admin/categories/view' + ${category.categoryId}}"
											class="btn btn-outline-info"><i class="fas fa-info mr-2"></i>Chi tiáº¿t</a>
										<a th:href="@{'/admin/categories/edit/' + ${category.categoryId}}"
											class="btn btn-outline-warning"><i class="fas fa-edit mr-2"></i>Chá»nh sá»­a</a>
										<a th:href="@{'/admin/categories/delete/' + ${category.categoryId}}"
											class="btn btn-outline-danger"
											onclick="return confirm('Báº¡n cÃ³ cháº¯c cháº¯n muá»n xÃ³a sáº£n pháº©m');">XÃ³a</a>
									</td>
								</tr>
							</tbody>
						</table>
