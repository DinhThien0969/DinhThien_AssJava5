...
<a th:href="@{'/admin/categories/delete/' + ${category.categoryId}}" class="btn btn-outline-danger"onclick="return confirm('bÃ¡ÂºÂ¡n thÃ¡Â»Â±c sÃ¡Â»Â± muÃ¡Â»Ân xÃÂ³a chÃ¡Â»Â©');">XÃ³a</a>
									</td>
								</tr>
							</tbody>
						</table>
